            ...
            <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
                <div className='grid mb-8 lg:grid-cols-6'>
                    <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                        ...
                        <div>
                            ...
                            <ul className='mt-2 space-y-2'>
                                ...
                                <li>
                                    <a href='/' className='text-gray-500 transition-colors duration-300 hover:text-blue-500'>References</a>
                                </li>
                            </ul>
                        </div>
                        {/* category 2 */}
                        ...
                        <div>
                            ...
                            <ul className='mt-2 space-y-2'>
                                <li>
                                    <a href='/' className='text-gray-500 transition-colors duration-300 hover:text-blue-500'>Infopreneur</a>
                                </li>
                                <li>
                    ...
                    <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            ...
                            <button type='submit' className='inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md hover:bg-blue-500 focus:outline-none border'>
                                Subcribe
                            </button>
                        </form>
                        <p className='mt-4 text-sm text-gray-500'>Lorem uashoiahc casocnsaoicn snsaioncosajbc wonxasbxoasx bcoisacbsoicsa casincsa csac sacioasc ascaisocas ccbjsac socibsa ck cjsa cscbjdsc</p>
                    </div>
                </div>
                <div className='flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row'>
                    ...
                    <div className='flex items-center mt-4 space-x-4 sm:mt-0'>
                        ...
                        <a href='' className='text-gray-500 transition-all duration-300 hover:text-blue-500'><FaInstagram className='h-6 w-6'/></a>
