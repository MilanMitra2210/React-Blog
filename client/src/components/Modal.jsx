...
const Modal = ({ isOpen, onClose }) => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center ${isOpen ? "" : "hidden"}`}>
            <div ref={modalRef} className='bg-indigo-900 text-center p-5 h-[21rem] lg:w-[500px] rounded shadow-md'>
                {/* modal content */}
                ...
                <form className='px-4'>
                    ...
                    <div className='flex justify-between'>
                        ...
                        <button onClick={onClose} className='bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-3 px-8 rounded inline-flex items-center'>Close</button>
                    </div>
                </form>
