    ...
    return (
        <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center ${isOpen ? "" : "hidden"}`}>
            <div className='bg-indigo-900 text-center p-5 h-96 lg:w-[500px] rounded shadow-md'>
                ...
                <form className='px-4'>
                    <div className='mb-5'>
                        <input type='email' name='email' id='email' placeholder='example@xyz.com' className='w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[$6a64f1] focus:shadow-md' />
                    </div>
                    <div className='mb-5'>
                        <input type='password' name='email' id='email' placeholder='Enter Your Password' className='w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[$6a64f1] focus:shadow-md' />
                    </div>
                    <div>
